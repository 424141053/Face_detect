...
class FaceRecognizer:
    def __init__(self, known_faces_dir=r"C:\Users\baby\Desktop\大实验\face\known_faces", tolerance=0.4):
...
class VideoCaptureThread(QThread):
    ...
    def __init__(self):
        ...
        self.face_recognizer = FaceRecognizer(tolerance=0.7)  # 调整tolerance提高准确性
        self.running = True
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.label_topright.setFixedSize(170, 200)  # 设置背景板的固定尺寸
